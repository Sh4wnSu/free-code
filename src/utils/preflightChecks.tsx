...
async function checkEndpoints(): Promise<PreflightCheckResult> {
  // MODIFIED: Preflight connectivity check disabled to allow offline/restricted-region usage
  return { success: true };
...
function _temp() {
  // MODIFIED: Disabled process.exit(1) on preflight failure to allow offline usage
  return;
